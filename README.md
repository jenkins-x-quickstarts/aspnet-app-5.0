...
You can build and run the sample locally with the [.NET Core 5.0 SDK](https://www.microsoft.com/net/download/core) using the following commands. The commands assume that you are in the root of the repository.
...
* [mcr.microsoft.com/dotnet/sdk:5.0](https://hub.docker.com/_/microsoft-dotnet-sdk/)
* [mcr.microsoft.com/dotnet/aspnet:5.0](https://hub.docker.com/_/microsoft-dotnet-aspnet/)
